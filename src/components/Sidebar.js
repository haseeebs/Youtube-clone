...
const Sidebar = () => {
  ...
  if (!isMenuOpen) return (
    <div className='shadow-xl px-3 py-4 h-screen'>
      <h3 className='p-2 w-28 rounded-md hover:bg-gray-300 cursor-pointer text-sm select-none font-bold bg-gray-200'>Home</h3>
  ...
  return (
    <div className='shadow-xl p-4'>
      <h3 className='p-3 w-52 rounded-md hover:bg-gray-300 cursor-pointer select-none font-bold bg-gray-200'>Home</h3>
